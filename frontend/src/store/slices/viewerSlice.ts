...
const viewerSlice = createSlice({
  ...
  reducers: {
    ...
    resetViewer: (state) => ({
      ...initialState,
      slices: {
        inline: { ...initialState.slices.inline },
        crossline: { ...initialState.slices.crossline },
        depth: { ...initialState.slices.depth },
      },
      volumeRendering: { ...initialState.volumeRendering },
      viewResetNonce: state.viewResetNonce + 1,
    }),
  },
});
